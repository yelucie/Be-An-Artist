...
public class ActionAnnulerRefaireTest {
	public ActionAnnulerRefaireTest() {
		testEffacer();
	}
	
	@Test
	private void testEffacer() {
		JFrame fenetre = new JFrame("Etre un Artiste - AnnulerRefaire");
